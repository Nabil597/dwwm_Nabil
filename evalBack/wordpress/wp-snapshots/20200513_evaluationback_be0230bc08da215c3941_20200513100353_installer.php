...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200513_evaluationback_be0230bc08da215c3941_20200513100353_archive.zip';
	const ARCHIVE_SIZE		 = '16944149';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'be0230b-13100353';
    const SECONDARY_PACKAGE_HASH = 'de1b4e6-13100353';
